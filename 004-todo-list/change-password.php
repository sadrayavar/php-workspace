    ...
    <form action="" class="row">
        <div class="col col-4">
            <div class="form-group">
                ...
                <input type="password" class="form-control ltr" id="old_password" name="old_password" required>
            </div>
        </div>
        <div class="col col-4">
            <div class="form-group">
                <label for="new_password">گذرواژه جدید</label>
                <input type="password" class="form-control ltr" id="new_password" name="new_password" required>
            </div>
        </div>
        <div class="col col-4">
            <div class="form-group">
                <label for="new_repassword">تکرار گذرواژه جدید</label>
                <input type="password" class="form-control ltr" id="new_repassword" name="new_repassword" required>
            </div>
        </div>
