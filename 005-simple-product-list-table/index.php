    ...
    <?php if (count($read_result[1]) > 0): ?>
      ...
      <?php foreach ($read_result[1] as $product): ?>
        <tr>
          ...
          <td>
            <div class="product-state <?php echo $product["state"] !== "draft" ? $product["state"] : null ?>">
              <?php
          ...
          <td>
            <div class="table-flex-col">
              ...
              <a href="<?php echo generate_querystring(["delete_product" => $product["title"]]) ?>" class="btn-icon delete-product">
